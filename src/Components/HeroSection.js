  ...
  return (
    <>
        ...
        >
            ...
            <motion.p variants={item} className='font-semibold text-4xl md:text-5xl roza text-opacity-70'>PR</motion.p>
            <div className='max-sm:hidden'></div>
              <motion.p variants={item} className='font-semibold text-3xl md:text-4xl span'>NOVINARSTVO</motion.p>
            <div className='max-sm:hidden'></div>
            <motion.img 
            ...
            ></motion.img>
            <div className='max-sm:hidden'></div>
            <motion.p variants={item} className='font-semibold text-3xl md:text-4xl roza text-opacity-60 text-center'>EVENT MENADŽMENT</motion.p>
            <div className='max-sm:hidden'></div>
