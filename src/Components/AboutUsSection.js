    ...
    <>
        <section className='flex flex-col h-full lg:h-[100vh] pt-32 lg:pt-8 overflow-hidden'>
            ...
            <div className='flex flex-col flex-1 lg:flex-row'>
                ...
                >
                    <p className='px-8 pt-10 text-lg text-white text-balance font-main'>Početkom 2022. ekipa studenata s Odjela za komunikologiju na Sveučilištu u Dubrovniku, odlučila je zagrebati ispod površine PR-a. Tako su skoknuli do Zagreba s projektom “Posjet u PR agencije - PR iz prve ruke”. Ali, to nije bilo dovoljno. 
                        Na jednoj kavi,  jedna od članica je dobila ideju - <u>donijeti iskustvo</u>  u Dubrovnik. 
                        </p> 
                        <br /><br />
                    <p className='px-8 text-lg text-white text-balance font-main'>
